...
public class VendorDaoImp implements VendorDao{
	...
	public boolean loginProcess(Vendor v) {
		String sql = "SELECT * FROM vendor_info WHERE username = :user_name AND password = :pwd";
		Vendor ven = null;
	...
	public boolean registerVendor(Vendor v) {
		String sql = "INSERT INTO vendor_info(Name,Email,Password) VALUES(:name,:user_name,:pwd);";
	...
	public List<Vendor> deleteVendor(int vid) {
		String sql = "DELETE from vendor_info WHERE id = :vid";
	...
	public Vendor editVendor(int vid) {
		String sql = "SELECT * FROM vendor_info WHERE id = :vid";
	...
	public boolean updateVendor(Vendor v) {
		String sql = "UPDATE vendor_info SET Name= :name, Name = :user_name WHERE id= :vid";
